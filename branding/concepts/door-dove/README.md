# Door & Dove — RCCG Jesus House, Middletown CT
...
(dove + red + arch), which the brief warned against. **Eliminated before the lockup stage**
— no `lockup.svg` was produced for this concept. Kept on disk as a record of the explored
direction.
